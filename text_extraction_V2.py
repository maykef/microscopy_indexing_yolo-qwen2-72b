...
TEXT_CLASSES = [
    "Text",           # Large paragraph blocks (body text)
    "Title",          # Main document titles
    "Section-header"  # Section headers and subtitles
    "List-item"       # Bulleted items
]
...
def main() -> int:
    ...
    print("\n" + "=" * 80)
    print("SCRIBE MODE V12 - WITH TITLES & SUBTITLES")
    print("=" * 80)
    print(f"Device: {DEVICE}")
    print("Strategy: YOLO (Text + Title + Section-header) + Qwen-72B (8-bit)")
    print("=" * 80)
